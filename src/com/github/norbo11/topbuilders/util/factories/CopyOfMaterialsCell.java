...
public class CopyOfMaterialsCell extends TreeTableCell<Job, Job> {
	...
	public CopyOfMaterialsCell(QuotesTab controller) {
	    super();
	...
	private void commit(RequiredMaterial requiredMaterial) {
    ...
    private void addMaterialRow(RequiredMaterial requiredMaterial) {
        ...
        quantityField.onActionProperty().addListener((obs, oldVal, newVal) -> commit(requiredMaterial));
        quantityField.focusedProperty().addListener((obs, oldVal, newVal) -> commit(requiredMaterial));
        ...
        searchList.getSelectionModel().selectedItemProperty().addListener((obs, oldValue, newValue) -> {
            if (newValue != null) {
                ...
                requiredMaterial.setStockedMaterial(newValue);
        ...
        nameField.textProperty().addListener((obs, oldVal, newVal) -> searchMaterials(searchList, oldVal, newVal)); //This needs to be after the above, as setText will trigger it 
